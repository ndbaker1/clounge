...
export type ObjectPropertiesRoomExtension = CursorRoomExtension & ViewportAnchorRoomExtension & {
    objectPropertiesPlugin: {
        ...
        spawnObject: (partialDescriptors: Partial<ObjectDescriptors["descriptors"]>) => ObjectPropertiesObjectExtension;
...
export default <RoomPlugin<ObjectPropertiesPeerExtension, ObjectPropertiesRoomExtension, ObjectPropertiesObjectExtension>>{
    ...
    processMessage(room, data: ObjectMessage) {
        if (data?.type === "object_position") {
            ...
            room.objectPropertiesPlugin.moveElementToFront(data.id, false);
    ...
    initialize(room) {
        ...
        room.objectPropertiesPlugin = {
            ...
            moveElementToFront(id, isSelf) {
                room.objectPropertiesPlugin.objectContainer.appendChild(
                    room.objectPropertiesPlugin.objectContainer.removeChild(
        ...
        window.addEventListener("mousedown", ({ button }) => {
            ...
            if (button === 0) {
                ...
                if (elementIdString != null) {
                    ...
                    room.objectPropertiesPlugin.moveElementToFront(elementId, true);
